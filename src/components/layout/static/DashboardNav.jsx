...
const DashboardNav = () => {
  ...
  const handlePlayerProfile = () => nav(`/player_profile/${player}`);
  const handlePlayerVideo = () => nav(`/player_video/${player}`);
  const handlePlayerSettings = () => nav(`/player_setting/${player}`);
